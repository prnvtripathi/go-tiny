...
export default async function DesktopNav() {
  ...
  return (
    <nav className="md:flex justify-between items-center py-3 px-12 hidden bg-black backdrop-blur-md bg-opacity-10 z-20 fixed left-0 right-0">
      <Logo />
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem>
                  ...
                  >
                    <button className="w-full text-red-500 flex items-center gap-2 font-bold">
